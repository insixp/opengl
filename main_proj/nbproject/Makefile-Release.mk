...
${OBJECTDIR}/close_function.o: close_function.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/close_function.o close_function.cpp

${OBJECTDIR}/keyboard_function.o: keyboard_function.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/keyboard_function.o keyboard_function.cpp

${OBJECTDIR}/load_function.o: load_function.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/load_function.o load_function.cpp

${OBJECTDIR}/primitives/CAMERA.o: primitives/CAMERA.cpp
	${MKDIR} -p ${OBJECTDIR}/primitives
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/primitives/CAMERA.o primitives/CAMERA.cpp

${OBJECTDIR}/primitives/CUBE.o: primitives/CUBE.cpp
	${MKDIR} -p ${OBJECTDIR}/primitives
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/primitives/CUBE.o primitives/CUBE.cpp

${OBJECTDIR}/primitives/OBJECT.o: primitives/OBJECT.cpp
	${MKDIR} -p ${OBJECTDIR}/primitives
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/primitives/OBJECT.o primitives/OBJECT.cpp

${OBJECTDIR}/render_function.o: render_function.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/render_function.o render_function.cpp

${OBJECTDIR}/resize_function.o: resize_function.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/resize_function.o resize_function.cpp

${OBJECTDIR}/shaders/BUFFER_ARRAY.o: shaders/BUFFER_ARRAY.cpp
	${MKDIR} -p ${OBJECTDIR}/shaders
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shaders/BUFFER_ARRAY.o shaders/BUFFER_ARRAY.cpp

${OBJECTDIR}/shaders/PROGRAM.o: shaders/PROGRAM.cpp
	${MKDIR} -p ${OBJECTDIR}/shaders
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shaders/PROGRAM.o shaders/PROGRAM.cpp

${OBJECTDIR}/shaders/SHADER.o: shaders/SHADER.cpp
	${MKDIR} -p ${OBJECTDIR}/shaders
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shaders/SHADER.o shaders/SHADER.cpp

${OBJECTDIR}/utils/utils.o: utils/utils.cpp
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/utils.o utils/utils.cpp

${OBJECTDIR}/win_main.o: win_main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/win_main.o win_main.cpp
